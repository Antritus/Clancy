...
@Command(key = "qntcore", name = "exception-command-simple-null")
public class SimpleCommandNullCommand extends SimpleCommand implements ExceptionCommand {
	@Override
	...
	public void trigger(Entity entity, String name, List<Argument<?>> arguments) {
		System.out.println("SCNC Triger");
	}
